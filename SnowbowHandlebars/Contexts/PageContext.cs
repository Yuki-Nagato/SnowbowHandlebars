...
namespace SnowbowHandlebars.Contexts {
	public record PageContext {
		...
		public PageContext(string layout, string commonName, string? language, string relativePath, string content, string? contentLanguage, Dictionary<string, object?>? frontMatter, ThemeConfig themeConfig) {
			Layout = layout;
		...
		public string Title => FrontMatterOrDefault("toc", CommonName).NN();
